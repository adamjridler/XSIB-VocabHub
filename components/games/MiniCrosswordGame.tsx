      ...
      >
        <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mt-6">
          ...
          <div className="lg:col-span-7 flex flex-col items-center justify-center bg-slate-900/60 backdrop-blur-2xl p-10 md:p-14 rounded-[3rem] border border-white/10 shadow-2xl relative overflow-hidden">
            ...
            <Button onClick={() => onGameOver(score, maxPossScore)} size="lg" className={`mt-6 h-16 px-12 rounded-full text-xl shadow-lg font-bold hover:scale-105 transition-all w-full md:w-auto ${isSuccess ? 'bg-emerald-600 hover:bg-emerald-500 shadow-emerald-600/30 text-white' : 'shadow-rose-600/30 bg-rose-600 hover:bg-rose-500'}`}>
              Continue Exploring
            </Button>
          </div>
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            <div className="bg-slate-900/40 p-6 rounded-3xl border border-white/5 flex flex-col justify-center">
              <div className="flex items-center gap-3 mb-2 text-slate-400">
                ...
                <span className="font-bold tracking-wide uppercase text-sm">Words Solved</span>
              </div>
            ...
            <div className="bg-slate-900/40 p-6 rounded-3xl border border-white/5 flex flex-col justify-center">
              ...
              <p className="text-4xl font-black text-white">{Math.ceil(timeRemaining)}s</p>
            </div>

            <LeaderboardForGame configId={`Crossword-${timeLimit}`} />
          </div>
        </div>
      </motion.div>
    );
