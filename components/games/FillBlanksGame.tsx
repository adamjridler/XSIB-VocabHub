      ...
      >
        <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center justify-center bg-slate-900/60 backdrop-blur-2xl p-8 md:p-10 rounded-[2.5rem] border border-white/10 shadow-2xl relative overflow-hidden">
            ...
            <Button onClick={() => onGameOver(score)} size="lg" className="mt-4 h-14 px-10 rounded-full text-lg shadow-blue-600/30 bg-blue-600 hover:bg-blue-500 font-bold hover:scale-105 transition-all w-full md:w-auto shadow-lg">
              Continue Exploring
            </Button>
          </div>
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3">
            <div className="bg-slate-900/40 p-4 md:p-5 rounded-2xl border border-white/5 flex flex-col justify-center">
              ...
              <p className="text-xs font-medium text-slate-500 mt-1">{stats.blanksFilledCorrectly} correct, {stats.blanksFilledWrong} mistakes</p>
            </div>
            ...
            <div className="bg-slate-900/40 p-4 md:p-5 rounded-2xl border border-white/5 flex flex-col justify-center">
              ...
              <p className="text-3xl font-black text-white">{pace}</p>
              <p className="text-xs font-medium text-slate-500 mt-1">Correct blanks / minute</p>
            </div>

            <div className="bg-slate-900/40 p-4 md:p-5 rounded-2xl border border-white/5 flex flex-col justify-center">
              <div className="flex items-center gap-3 mb-1 text-slate-400">
                <CheckCircle2 className="w-4 h-4 text-blue-500" />
                <span className="font-bold tracking-wide uppercase text-xs">Paragraphs Done</span>
              </div>
              <p className="text-3xl font-black text-white">{stats.paragraphsCompleted}</p>
            </div>
            
            <LeaderboardForGame configId={`FillBlanks-${mode}`} limit={4} />
          </div>
        </div>
      </motion.div>
    );
